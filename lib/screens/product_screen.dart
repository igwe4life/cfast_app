...
import 'package:shop_example/widgets/GridSimilar.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  Future<void> toggleFavorite() async {
    ...
    ///Fluttertoast.showToast(msg: 'Request for toggleFavorite started!');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        //     msg: 'toggleFavorite response: ${response.body.toString()}');
        setState(() {
          isFavoriteLoading = false;
        });
      } else {
        // Fluttertoast.showToast(msg: 'Request for toggleFavorite error!');
        setState(() {
          isFavorite = !isFavorite;
          isFavoriteLoading = false;
        });
      ...
      print('Error: $error');
      // Fluttertoast.showToast(msg: 'Request for toggleFavorite: Error: $error');
      setState(() {
        isFavorite = !isFavorite;
        isFavoriteLoading = false;
      });
